...
export const agenceService = {
  ...
  createAgence: (data) => axiosInstance.post(API.AGENCES.DISTRIBUTEUR, data),  // Utiliser DISTRIBUTEUR pour créer une agence par le distributeur
// createAgence: (data) => axiosInstance.post(API.AGENCES.BASE, data),  // Utiliser BASE au lieu de DISTRIBUTEUR pour creer une agence par l'admin
