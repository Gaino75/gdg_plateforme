...
export const API = {
  ...
  AGENCES: {
    ...
    VALIDER: (id, adminId) => `${GATEWAY_URL}/api/agences/${id}/valider?adminId=${adminId}`,
  ...
  STOCK: {
    ...
    CRITIQUES: (agenceId) => `${GATEWAY_URL}/api/stocks/agence/${agenceId}/critiques`,
    HISTORIQUE: (agenceId) => `${GATEWAY_URL}/api/stocks/agence/${agenceId}/historique`,
    ...
    SEUIL: (agenceId, categorieId) => `${GATEWAY_URL}/api/stocks/agence/${agenceId}/categorie/${categorieId}/seuil`,
  },
  ...
  VENTES: {
    ...
    DISTRIBUTEUR: (distributeurId) => `${GATEWAY_URL}/api/ventes/distributeur/${distributeurId}`,
  ...
  RESERVATIONS: {
    ...
    CONSOMMATEUR_ACTIVES: (id) => `${GATEWAY_URL}/api/reservations/consommateur/${id}/actives`,
    ...
    PAIEMENT: (id, ref) => `${GATEWAY_URL}/api/reservations/${id}/paiement?referencePaiement=${ref}`,
  },
  ...
  NOTIFICATIONS: {
    ...
    USER_UNREAD_COUNT: (id) => `${GATEWAY_URL}/api/notifications/user/${id}/unread/count`,
    ...
    ABONNEMENTS_CONSOMMATEUR: (id) => `${GATEWAY_URL}/api/abonnements/consommateur/${id}`,
    SIGNALEMENTS: `${GATEWAY_URL}/api/signalements`,
    SIGNALEMENTS_AGENCE: (agenceId) => `${GATEWAY_URL}/api/signalements/agence/${agenceId}`,
