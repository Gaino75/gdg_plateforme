...
import com.gdg.service_ventes.exception.VenteEchoueException; 
...
public class VenteService {
    ...
    public VenteResponse enregistrerVente(VenteRequest request) {
        ...
        // Mettre à jour le stock si echou on annule la vente
        try {
            ...
            log.error(" Erreur lors de la mise à jour du stock,vente annulée: {}", e.getMessage());
            throw new VenteEchoueException("impossible de mettre à jour le stock, la vente a été annulée", e);
        }
